...
from analizers import host_discover, host_forced_discover, host_simple_analizer
...
simple_host_analyzer = host_simple_analizer(hosts)

separate_bar()
print(f"\033[1;33mBUILDING DATA SOURCE...")


df = simple_scan_df(simple_host_analyzer[0], simple_host_analyzer[1], simple_host_analyzer[2],
                    simple_host_analyzer[3], simple_host_analyzer[4], simple_host_analyzer[5], simple_host_analyzer[6])
...
final_host_resume(end_time, start_time, hosts, simple_host_analyzer[4])
